...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.showQuad = false;
        this.showQuadMaterial = false;
        this.showTangram = false;
        this.showCubeQuad = false;
    ...
    display() {
        ...
        if (this.displayAxis)
            this.axis.display();
        if(this.showQuad) this.quad.display();
        if(this.showTangram) this.tangram.display();
        if(this.showCubeQuad) this.cubeQuad.display();
        ...
        if(this.showQuadMaterial) this.quadMaterial.apply();
