...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'showQuad').name('Display Quad');
        this.gui.add(this.scene, 'showQuadMaterial').name('Quad Material');
        this.gui.add(this.scene, 'showTangram').name('Display Tangram');
        this.gui.add(this.scene, 'showCubeQuad').name('Display Cube');
