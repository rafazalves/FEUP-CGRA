...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.pyramid = new MyPyramid(this, 0, 1);
    ...
    initMaterials() {
        ...
        // Wood like Material
        this.WoodLike = new CGFappearance(this);
        this.WoodLike.setAmbient(139/255,69/255,19/255, 1.0);
        this.WoodLike.setDiffuse(0,0,0, 1.0);
        this.WoodLike.setSpecular(0, 0, 0, 1.0);
        this.WoodLike.setShininess(10.0);
        ...
        this.materials = [this.material1, this.material2, this.material3, this.WoodLike, this.customMaterial];
